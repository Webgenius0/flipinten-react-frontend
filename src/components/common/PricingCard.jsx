...
console.log(plan)
  ...
  return (
    <div className="py-[48px] px-8 flex flex-col justify-between gap-8 rounded-3xl bg-white customHoverEffect">
      {/* details */}
      <div className="space-y-8">
        ...
        <div className="">
          <h3 className="text-[#1C1D20] text-[20px] font-medium leading-[30px]">
            {plan.title}
          </h3>
          <h4 className="text-[#4F586D] text-[16px] leading-6">
            {plan.setupTime}
          </h4>
        </div>
